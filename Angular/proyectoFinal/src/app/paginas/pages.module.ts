...
import { EntregasComponent } from './ranking-page/practicas/entregas/entregas.component';


@NgModule({
  declarations: [MainPageComponent, StudentPageComponent,TeacherPageComponent, ProfileTeacherComponent, ProfileStudentComponent, ChangePasswordDialogComponent, RankingPageComponent, EntregasComponent  ],
  imports: [
    PagesRoutingModule,
    MatFormFieldModule,
    FormsModule,
